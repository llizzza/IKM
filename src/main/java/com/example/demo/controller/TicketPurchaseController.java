 ...
 *
 * Отвечает за просмотр списка покупок,
 * добавление новой покупки и удаление существующей.
 */
@Controller
...
public class TicketPurchaseController {
     ...
     * на страницу со списком покупок.
     *
     ...
     *
     * В форму передаётся пустой объект покупки,
     * а также списки клиентов и абонементов
     * для выбора.
     *
     * @param model объект для передачи данных в представление
